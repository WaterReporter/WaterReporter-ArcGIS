...
@interface WaterReporterFeatureLayer ()
...
@implementation WaterReporterFeatureLayer
...
- (id)initWithURL:(NSURL *)url mode:(AGSFeatureLayerMode)mode online:(BOOL)online
{
     ...
     */
    NSLog(@"WaterReporterFeatureLayer: initWithURL");
...
{
    return [[[WaterReporterFeatureLayer alloc] initWithURL:url mode:mode] autorelease];
}

+ (id)featureServiceLayerWithURL:(NSURL *)url mode:(AGSFeatureLayerMode)mode online:(BOOL)online
{
    return [[[WaterReporterFeatureLayer alloc] initWithURL:url mode:mode online:online] autorelease];
}
...
-(void)prepForOfflineUse:(AGSEnvelope *)extent
{
     ...
     * This allows us to see what is being fired and when
     */
    NSLog(@"WaterReporterFeatureLayer: prepForOfflineUse");
...
-(void)addOfflineFeature:(AGSGraphic *)feature withAttachments:(NSArray *)attachments
{
     ...
     * This allows us to see what is being fired and when
     */
    NSLog(@"WaterReporterFeatureLayer: addOfflineFeature");
...
-(void)commitOfflineFeatures
{
     ...
     * This allows us to see what is being fired and when
     */
    NSLog(@"WaterReporterFeatureLayer: commitOfflineFeatures");
...
-(void)featureLayer:(AGSFeatureLayer *)featureLayer operation:(NSOperation*)op didFeatureEditsWithResults:(AGSFeatureLayerEditResults *)editResults{
     ...
     * This allows us to see what is being fired and when
     */
    NSLog(@"WaterReporterFeatureLayer: didFeatureEditsWithResults");
...
-(void)featureLayer:(AGSFeatureLayer *)featureLayer operation:(NSOperation*)op didFailFeatureEditsWithError:(NSError *)error{
     ...
     * This allows us to see what is being fired and when
     */
    NSLog(@"WaterReporterFeatureLayer: didFailFeatureEditsWithError");
...
-(void)featureLayer:(AGSFeatureLayer *)featureLayer operation:(NSOperation*)op didAttachmentEditsWithResults:(AGSFeatureLayerAttachmentResults *)attachmentResults{
     ...
     * This allows us to see what is being fired and when
     */
    NSLog(@"WaterReporterFeatureLayer: didAttachmentEditsWithResults");
...
-(void)featureLayer:(AGSFeatureLayer *)featureLayer operation:(NSOperation*)op didFailAttachmentEditsWithError:(NSError *)error{
     ...
     * This allows us to see what is being fired and when
     */
    NSLog(@"WaterReporterFeatureLayer: didFailAttachmentEditsWithError");
...
-(void)finishedWithSuccess:(NSInteger)nSuccessCount failed:(NSInteger)nFailCount{
     ...
     * This allows us to see what is being fired and when
     */
    NSLog(@"WaterReporterFeatureLayer: finishedWithSuccess");
...
-(void)doneFailed{
     ...
     * This allows us to see what is being fired and when
     */
    NSLog(@"WaterReporterFeatureLayer: doneFailed");
...
{    
     ...
     * This allows us to see what is being fired and when
     */
    NSLog(@"WaterReporterFeatureLayer: didQueryFeaturesWithFeatureSet");
...
- (void)featureLayer:(AGSFeatureLayer *)featureLayer operation:(NSOperation*)op didFailQueryFeaturesWithError:(NSError *)error
{
     ...
     * This allows us to see what is being fired and when
     */
    NSLog(@"WaterReporterFeatureLayer: didFailQueryFeaturesWithError");
...
{    
     ...
     * This allows us to see what is being fired and when
     */
    NSLog(@"WaterReporterFeatureLayer: isOnline");
...
-(void)writeFeatureLayerDefinition
{
     ...
     * This allows us to see what is being fired and when
     */
    NSLog(@"WaterReporterFeatureLayer: writeFeatureLayerDefinition");
...
-(void)writeFeatureSet:(AGSFeatureSet *)featureSet
{
     ...
     * This allows us to see what is being fired and when
     */
    NSLog(@"WaterReporterFeatureLayer: writeFeatureSet");
...
-(void)writeAddedFeatures:(NSArray *)addedFeatures
{
     ...
     * This allows us to see what is being fired and when
     */
    NSLog(@"WaterReporterFeatureLayer: writeAddedFeatures");
...
-(void)writeAddedAttachments:(NSArray *)addedAttachments
{
     ...
     * This allows us to see what is being fired and when
     */
    NSLog(@"WaterReporterFeatureLayer: writeAddedAttachments");
...
-(NSDictionary *)readFeatureLayerDefinition
{
     ...
     * This allows us to see what is being fired and when
     */
    NSLog(@"WaterReporterFeatureLayer: readFeatureLayerDefinition");
...
-(NSDictionary *)readFeatureSet
{
     ...
     * This allows us to see what is being fired and when
     */
    NSLog(@"WaterReporterFeatureLayer: readFeatureSet");
...
-(NSMutableArray *)readAddedFeatures
{
     ...
     * This allows us to see what is being fired and when
     */
    NSLog(@"WaterReporterFeatureLayer: readAddedFeatures");
...
-(NSMutableArray *)readAddedAttachments
{
     ...
     * This allows us to see what is being fired and when
     */
    NSLog(@"WaterReporterFeatureLayer: readAddedAttachments");
...
-(NSString *)featureSetFilename
{
     ...
     * This allows us to see what is being fired and when
     */
    NSLog(@"WaterReporterFeatureLayer: featureSetFilename");
...
-(NSString *)featureLayerDefinitionFilename
{
     ...
     * This allows us to see what is being fired and when
     */
    NSLog(@"WaterReporterFeatureLayer: featureLayerDefinitionFilename");
...
-(NSString *)addedFeaturesFilename
{
     ...
     * This allows us to see what is being fired and when
     */
    NSLog(@"WaterReporterFeatureLayer: addedFeaturesFilename");
...
-(NSString *)addedAttachmentsFilename
{
     ...
     * This allows us to see what is being fired and when
     */
    NSLog(@"WaterReporterFeatureLayer: addedAttachmentsFilename");
...
-(BOOL) validNetworkConnection
{
     ...
     * This allows us to see what is being fired and when
     */
    NSLog(@"WaterReporterFeatureLayer: validNetworkConnection");
