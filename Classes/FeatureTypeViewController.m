...
- (void)viewDidLoad {
     ...
     */
    NSLog(@"FeatureTypeViewController:viewDidLoad");
...
- (NSInteger)numberOfSectionsInTableView:(UITableView *)tableView {
     ...
     * This allows us to see what is being fired and when
     */
    NSLog(@"FeatureTypeViewController:tableView:numberOfSectionsInTableView");
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
     ...
     * This allows us to see what is being fired and when
     */
    NSLog(@"FeatureTypeViewController:tableView:numberOfRowsInSection");
...
-(AGSFeatureTemplate*)templateForIndex:(int)index{
     ...
     * This allows us to see what is being fired and when
     */
    NSLog(@"FeatureTypeViewController:templateForIndex");
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
     ...
     * This allows us to see what is being fired and when
     */
    NSLog(@"FeatureTypeViewController:tableView:cellForRowAtIndexPath");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
     ...
     * This allows us to see what is being fired and when
     */
    NSLog(@"FeatureTypeViewController:tableView:didSelectRowAtIndexPath");
...
- (void)didReceiveMemoryWarning {
     ...
     * This allows us to see what is being fired and when
     */
    NSLog(@"FeatureTypeViewController:didReceiveMemoryWarning");
...
- (void)viewDidUnload {
     ...
     * This allows us to see what is being fired and when
     */
    NSLog(@"FeatureTypeViewController:viewDidUnload");
...
- (void)dealloc {
     ...
     * This allows us to see what is being fired and when
     */
    NSLog(@"FeatureTypeViewController:dealloc");
